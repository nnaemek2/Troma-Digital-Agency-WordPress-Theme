...
?>
<div class="ct-fancybox-layout7 <?php echo esc_attr($el_class.' '.$animation_classes); ?>">
	<div class="ct-fancybox-inner">
        ...
        <div class="ct-fancybox-content">
            ...
            <?php endif;?>
            <?php if(!empty($a_href)) : ?><a class="ct-fancybox-more" href="<?php echo esc_url($a_href);?>" target="<?php  echo esc_attr($a_target); ?>"></a><?php endif; ?>
        </div>
	</div>
</div>