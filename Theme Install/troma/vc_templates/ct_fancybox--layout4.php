...
extract(shortcode_atts(array(
    ...
    'btn_link' => '',
    'item_same_height' => 'col-same-height',
    'styles' => 'style1',
...
?>
<div class="ct-fancybox-layout4 <?php echo esc_attr($styles.' '.$el_class.' '.$animation_classes); ?>">
	<div class="ct-fancybox-inner <?php echo esc_attr($item_same_height); ?>">
        ...
        <?php } else { ?>
            <?php if($icon_class):?>
                <div class="ct-fancybox-icon">
                    <i class="<?php echo esc_attr($icon_class); ?> text-gradient" style="<?php if(!empty($icon_color)) { echo 'color:'.esc_attr($icon_color).';'; } if(!empty($icon_font_size)) { echo 'font-size:'.esc_attr($icon_font_size).'px;'; } ?>"></i>
                </div>
            <?php endif;?>
        <?php } ?>
