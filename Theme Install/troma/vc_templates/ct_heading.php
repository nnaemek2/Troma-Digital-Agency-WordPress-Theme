...
<div id="<?php echo esc_attr($atts['html_id']);?>" class="ct-heading <?php echo esc_attr( $align_lg.' '.$align_md.' '.$align_sm.' '.$align_xs.' '.$animation_classes ); ?>">
    ...
    <?php if(!empty($subtitle)) : ?>
        <h6 class="ct-heading-sub <?php echo esc_attr($subtitle_style); ?> <?php if(!empty($subtitle_color)) { echo 'colored'; } ?>" <?php echo !empty($subtitle_styles) ? 'style="' . esc_attr($subtitle_styles) . '"' : '' ?>>
