...
$post_social_share_on = troma_get_opt( 'post_social_share_on', false );
$post_tags_on = troma_get_opt( 'post_tags_on', true );
$post_feature_image_on = troma_get_opt( 'post_feature_image_on', false );
