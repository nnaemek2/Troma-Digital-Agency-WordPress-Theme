...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-grid-direction direction-fade ct-grid-portfolio-layout2 images-light-box <?php echo esc_attr($el_class); ?>">
                            ...
                            <div class="item-direction">
                                ...
                                <div class="item-holder">
                                    <?php if(!empty($portfolio_video_url)) { ?>
                                        <a class="light-box-video" href="<?php echo esc_url($portfolio_video_url); ?>"><i class="fa fa-video-camera"></i></a>
                                    <?php } else { ?>
