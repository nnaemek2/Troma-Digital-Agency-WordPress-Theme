...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-team-member-layout4 <?php echo esc_attr($el_class.' '.$animation_classes); ?>">
    <div class="ct-team-member-inner">
        ...
        <div class="ct-team-holder">
            ...
            <?php if(!empty($position)) : ?>
                <div class="ct-team-position subtitle"><?php echo esc_attr( $position ); ?></div>
            <?php endif; ?>
        </div>
